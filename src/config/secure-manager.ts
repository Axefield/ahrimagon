...
export class AhrimagonSecureConfigManager {
  private static instance: AhrimagonSecureConfigManager;
  ...
  static getInstance(): AhrimagonSecureConfigManager {
    if (!AhrimagonSecureConfigManager.instance) {
      AhrimagonSecureConfigManager.instance = new AhrimagonSecureConfigManager();
    }
    return AhrimagonSecureConfigManager.instance;
  }
  ...
  private findConfigFile(): string | null {
    const possibleNames = ['.ahrimagon', '.ahrimagon.scientific', 'ahrimagon.json'];
...
export const secureConfigManager = AhrimagonSecureConfigManager.getInstance();
